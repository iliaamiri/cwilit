<?php $witcher = new witcher();$witcher->requireController("login");$witcher->requireController("home");$login = new \Controller\welcome();$home = new \Controller\home();$home_data = $home->getData();
    ...
    <header class="header-container hidden-tablet hidden-mobile js-header-container">
        ...
        <nav class="desktop-main-menu">
            <div class="main-menu-wrapper"><?php if ($login->is_login() == 1){?>
                ...
                <div class="menu-item menu-item--casino"><a class="btn-casino" href="<?=HTTP_SERVER?>/ticket/buy?c=<?=$latest_comp['Competition_Id']?>">شرکت در آخرین مسابقه</a></div>
            </div>
        </nav>
    </header>
