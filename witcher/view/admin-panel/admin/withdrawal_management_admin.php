                        ...
                        <div class="x_content">
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center;font-size: 20px;">بررسی</th>
                                </tr>
                                </thead>

                                <tbody>
                                <?php if ($withdrawals_data){
                                    $row_num = 1;
                                    foreach ($withdrawals_data as $value){?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;direction: ltr    !important;">
                                            <a href="/profile/withdrawals_info?id=<?=$value['id']?>" class="btn btn-primary" style="width: 100%;-webkit-border-radius: 100px;-moz-border-radius: 100px;border-radius: 100px;">بررسی </a>
                                        </td>
                                    </tr>
                                <?php $row_num++;}}?>
                                </tbody>
